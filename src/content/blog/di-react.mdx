...
description: "Инверсия зависимостей в React"
pubDate: "Feb 25 2023"
heroImage: "/images/di-react/hero.png"
---
...
![Компонент, отображающий список элементов](/images/di-react/list-component.png)
...
![Кастомизированный список](/images/di-react/customized-list.png)
...
![Кастомизация отдельно взятых элементов](/images/di-react/customized-list-item.png)

При текущем подходе реализация `List` напрямую зависит от конкретной реализации `ListItem`.

![Прямая зависимость](/images/di-react/direct-dependency.png)
...
![Инвертированные зависимости](/images/di-react/inverted-depndency.png)

## Расширяем поведение компонента

Следующей задачей стала реализация поиска в этом списке.

![Список с поиском](/images/di-react/searchable-list.png)
...
![Зависимость от общей абстракции](/images/di-react/common-abstraction.png)
...
![Зависимость от контекста](/images/di-react/context-dependency.png)
